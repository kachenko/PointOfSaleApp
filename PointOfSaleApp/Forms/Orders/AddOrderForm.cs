	...
	public partial class NewOrderForm : Form
	{
        ...
        private void loadDishDataGridView()
        {
            ...
            try
            {
                ...
                dataDishGridView.Columns[0].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
        ...
        private void addProductButton_Click(object sender, EventArgs e)
        {
            if (dishIDTextBox.Text != "" && dishNameTextBox.Text != "" && dishPriceTextBox.Text != "")
            {
                try
                {
                    ...
                    // dataOrderGridView.Columns[0].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
                    dataOrderGridView.Columns[1].Name = "Name";
                    dataOrderGridView.Columns[1].Width = 70;
                    dataOrderGridView.Columns[2].Name = "Quantity";
                    // dataOrderGridView.Columns[2].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
                    dataOrderGridView.Columns[3].Name = "Price";
                    // dataOrderGridView.Columns[3].AutoSizeMode = DataGridViewAutoSizeColumnMode.ColumnHeader;
        ...
        private int orderCreate() 
        {
            ...
            try
            {
                ...
                retval = (int)command.Parameters["@order_id"].Value;
