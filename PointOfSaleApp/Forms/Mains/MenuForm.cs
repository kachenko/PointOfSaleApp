    ...
    public partial class MenuForm : Form
    {
        ...
        private void accessToButtons()
        {
            if (MyUserClass.userRoleId == 1)
            {
                ...
                tablesButton.Visible = true;
                paymentMethodButton.Visible = true;
            }
            else
            {
                newOrderButton.Visible = true;
                ...
                tablesButton.Visible = false;
                paymentMethodButton.Visible = false;
            }
        }
        ...
        {
            Forms.PaymentMethodForm paymentMethodForm = new Forms.PaymentMethodForm();
            this.Hide();
