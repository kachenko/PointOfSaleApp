...
namespace PointOfSaleApp.Forms
{
    public partial class AddCategoryForm : Form
    {
        ...
        {
            // TODO: Ten wiersz kodu wczytuje dane do tabeli 'dishCategoryDataSet.DishCategory' . Możesz go przenieść lub usunąć.
            this.dishCategoryTableAdapter.Fill(this.dishCategoryDataSet.DishCategory);
